<div class="row">
  <div class="col">
    <a href="distribuicao/DisRoteirizacao.php" class="btn btn-primary btn-sm" style="color: white;"> Roteirização </a>
    <a href="distribuicao/DisListagemEntrega.php" class="btn btn-primary btn-sm" style="color: white;"> Listagem de Entrega por Setor</a>
    <div class="mb-3"></div>
