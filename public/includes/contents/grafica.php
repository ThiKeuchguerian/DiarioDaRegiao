<div class="row">
  <div class="col">
    <a href="grafica/GrafCheckMetas.php" class="btn btn-primary btn-sm" style="color: white;">Check Metas Gráfica</a>
    ...
    <!-- <a href="grafica/GrafRelatorioFreteArte.php" class="btn btn-primary btn-sm" style="color: white;">Relatório Frete & Arte</a> -->
    <div class="mb-3"></div>
