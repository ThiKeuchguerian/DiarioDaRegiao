<div class="row">
  <div class="col">
    ...
    <div class="mb-3"></div>
    <!-- <a href="CadCartaoAnunCielo.php" class="btn btn-primary btn-sm" style="color: white;"> Cadastro Cartão - Anuncios Cielo </a> -->
    <div class="mb-3"></div>
    <a href="classif/ClassifAnunWebTake.php" class="btn btn-primary btn-sm" style="color: white;"> Consulta Anúncios WebTake </a>
  </div>
</div>