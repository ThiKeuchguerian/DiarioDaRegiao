  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style="font-weight: bold;" id="modal">Editar Pedido - <?= $item['numped'] ?></h5>
        ...
        <div class="modal-body mb-0">
          ...
          <div class="row mb-3">
            <div class="col">
              ...
              <input type="text" class="form-control" id="numped" name="numped" readonly>
            </div>
            <div class="col">
              <label for="pedcli" class="form-label" style="font-weight: bold;">Cod. NumPed</label>
              <input type="text" class="form-control" id="pedcli" name="pedcli" readonly>
            </div>
            <div class="col">
          ...
          <div class="row mb-3">
            <div class="col">
              ...
              <input type="text" class="form-control" id="codfam" name="codfam" readonly>
            </div>
            <div class="col">
              <label for="codser" class="form-label" style="font-weight: bold;">Código do Serviço</label>
              <input type="text" class="form-control" id="codser" name="codser" readonly>
            </div>
            <div class="col">
              <label for="tnsser" class="form-label" style="font-weight: bold;">Transação Serviço</label>
              <input type="text" class="form-control" id="tnsser" name="tnsser" readonly>
            </div>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="desser" name="desser" readonly>
          </div>
