      ...
      <form action=<?= $URL ?> method="post" id="form" name="form">
        ...
        <div class="card-body">
          <div class="row justify-content-center">
            ...
            <div class="col">
              <input type="text" class="form-control form-control-sm" id="NumNota" name="NumNota" placeholder="Nº Nota Fiscal" maxlength="10">
            </div>
            <div class="col">
            ...
            <?php foreach ($dadosNFV as $key => $item): ?>
              <tr>
                ...
                <td><button class="btn btn-primary btn-edit btn-sm" id="btn-edit-nota-modal" data-bs-toggle="modal" data-bs-target="#modal"
                    ...
                    data-vlrirf="<?= number_format($item['vlrirf'], 6, ',', '.') ?>"
                    data-vlrbcl="<?= number_format($item['vlrbcl'], 2, ',', '.') ?>"
                    data-vlrcsl="<?= number_format($item['vlrcsl'], 6, ',', '.') ?>"
                    data-vlrbpt="<?= number_format($item['vlrbpt'], 2, ',', '.') ?>"
                    data-vlrpit="<?= number_format($item['vlrpit'], 6, ',', '.') ?>"
                    data-vlrbct="<?= number_format($item['vlrbct'], 6, ',', '.') ?>"
                    data-vlrcrt="<?= number_format($item['vlrcrt'], 6, ',', '.') ?>"
                    data-vlrtotal="<?= number_format($item['VlrRetencao'], 6, ',', '.') ?>">Editar</button></td>
              </tr>
            <?php endforeach; ?>
          </tbody>
          <tbody>
